...
namespace PMSoft.Data.Infrastructure
{
    ...
    /// Object context
    /// </summary>
    public class PmSoftObjectContext : DbContext, IDbContext
    {
        private ILogger logger;
 
        public PmSoftObjectContext(string nameOrConnectionString)
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
         ...
         /*   MappingTypeList list = WorkContext.CurrentContext.Resolve<MappingTypeList>();
            var typesToRegister = list.List.Distinct();
