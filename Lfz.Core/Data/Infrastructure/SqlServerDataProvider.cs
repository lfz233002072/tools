...
using System.IO;
using System.Text;
using PMSoft.Data.Initializers;
...
namespace PMSoft.Data.Infrastructure
{
    public class SqlServerDataProvider : BaseEfDataProvider
    {
        ...
        public override void SetDatabaseInitializer()
        {
            ...
            customCommands.AddRange(ParseCommands(Utils.MapPath("~/App_Data/SqlServer.Indexes.sql"), false)); 

            var initializer = new CreateTablesIfNotExist<PmSoftObjectContext>(tablesToValidate, customCommands.ToArray());
