...
namespace Lfz
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual string GetStoreHost(bool useSsl = false)
        {
            var result = "";
        ...
        public virtual string GetParamValueByName(string name)
        {
            string value = null;
            if (HttpContext.Current != null && HttpContext.Current.Request.Params[name] != null)
