...
namespace Lfz.Utitlies
{
    ...
    public class DigitToMoneyText
    {
        ...
        public static string ConvertMoney(string strDigit, bool bToRMB = true)
        {
            return new DigitToMoneyText().Convert(strDigit, bToRMB);
        }
